...
- `GATEWAY_DRAIN_TIMEOUT_S`、`GATEWAY_DEPLOY_DRAIN_GRACE_S`、`GATEWAY_MAINTENANCE_LOOP_INTERVAL_S`、`GATEWAY_MODEL_SYNC_INTERVAL_S` — Gateway 后端 drain、部署切换等待、维护循环和模型同步间隔
